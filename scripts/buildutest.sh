...
apollo_config_db_url=jdbc:mysql://192.168.0.140:3306/ApolloConfigDB?characterEncoding=utf8
apollo_config_db_username=ejltest
apollo_config_db_password=testonly2016

# apollo portal db info
apollo_portal_db_url=jdbc:mysql://192.168.0.140:3306/ApolloPortalDB?characterEncoding=utf8
apollo_portal_db_username=ejltest
apollo_portal_db_password=testonly2016

# meta server url, different environments should have different meta server addresses
dev_meta=http://192.168.0.136:11001
fat_meta=http://192.168.0.137:11001
